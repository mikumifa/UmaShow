...
{
  int8_t train = -1;//01234速耐力根智，5ss对战，6休息或者法棍，7友人外出，8普通外出，9比赛 
  //注：不排除极个别情况下普通外出比友人外出好，比如友人走到第三段后掉心情（第四段不回心情），而且马上远征
  bool buy50p = false;//买不买对应训练的+50%
  bool buyPt10 = false;//买不买pt+10
  bool buyFriend20 = false;//买不买友情+20%
  bool buyVital20 = false;//买不买体力消耗-20%
